...
<form action="" method="POST">
    <table border="2" colspan="10" style="margin-left:400px" >
                ...
                <tr>
                    <td width="114"> COMPUTER_NETWORKS</td>
                    <td width="200" align="center"> <input type="text" name="COMPUTER_NETWORKS" placeholder="Enter marks"/> </td>
                </tr>

                <tr>
                    <td width="114"> DSA </td>
                    <td width="200" align="center"> <input type="text" name="DSA" placeholder="Enter marks"/> </td>
                </tr>
...
<?php
    if(isset($_POST['S']))
    {
        ...
        $query = "INSERT INTO marks(REG_NO,MATHS,PHYSICS,COMPUTER_NETWORKS,DSA,ENGLISH) VALUES ('$REG_NO','$MATHS','$PHYSICS','$COMPUTER_NETWORKS','$DSA','$ENGLISH') ";
