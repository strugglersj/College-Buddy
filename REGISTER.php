...
if(isset( $_POST['REG']))
{
    ...
    $query = "INSERT INTO profile (REG_NO,NAME,GENDER,DOB,BLOOD_GROUP,PHONE,EMAIL,PROGRAM,BRANCH,STREET,AREA,CITY,STATE,PIN,COUNTRY,USER_NAME,PASSWORD) VALUES ('$REG_NO','$NAME','$GENDER','$DOB','$BLOOD_GROUP','$PHONE','$EMAIL','$PROGRAM','$BRANCH','$STREET','$AREA','$CITY','$STATE','$PIN','$COUNTRY','$USER_NAME','$PASSWORD')";
